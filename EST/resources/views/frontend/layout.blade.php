...
<head>
    <meta charset="utf-8">
    <title>@yield('title') - {{ config('app.name', '| EST') }}</title>
        ...
        <nav class="navbar navbar-expand-lg header-nav">
            <div class="navbar-header">
                ...
                <a href="index-2.html" class="navbar-brand logo">
                    <img src="../../../assets2/img/logo.png" class="img-fluid" alt="Logo">
                </a>
            </div>
            <div class="main-menu-wrapper">
                ...
                <ul class="main-nav">
                    ...
                    <li class="has-submenu active">
                        ...
                        <ul class="submenu">
                            <li class="active"><a href="doctor-dashboard.html">Employer Dashboard</a></li>
            ...
            <ul class="nav header-navbar-rht">
                ...
                <li class="nav-item dropdown has-arrow logged-item">
                    <a href="#" class="dropdown-toggle nav-link" data-toggle="dropdown">
								<span class="user-img">
									<img class="rounded-circle" src="../../../assets2/img/doctors/doctor-thumb-02.jpg"
                                         width="31"
                                         alt="Darren Elder">
								</span>
                    </a>
                    <div class="dropdown-menu dropdown-menu-right">
                        ...
                        <a class="dropdown-item" href="/emlogout">Logout</a>
                    </div>
                </li>
                <!-- /User Menu -->
        ...
        <div class="container-fluid">
            <div class="row align-items-center">
                <div class="col-md-12 col-12">
                    ...
                    <h2 class="breadcrumb-title">Employer Dashboard</h2>
                </div>
            </div>
        </div>
    </div>
                    ...
                    <div class="col-lg-3 col-md-6">
                        ...
                        <div class="footer-widget footer-about">
                            <div class="footer-logo">
                                <img src="../../../assets2/img/footer-logo.png" alt="logo">
                            </div>
...
<!-- Sticky Sidebar JS -->
<script src="../../../assets2/plugins/theia-sticky-sidebar/ResizeSensor.js"></script>
<script src="../../../assets2/plugins/theia-sticky-sidebar/theia-sticky-sidebar.js"></script>

<!-- Circle Progress JS -->
<script src="../../../assets2/js/circle-progress.min.js"></script>
