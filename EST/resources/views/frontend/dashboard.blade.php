    ...
    <div class="container-fluid">
        ...
        <div class="row">
                    ...
                    <div class="widget-profile pro-widget-content">
                        <div class="profile-info-widget">
                            <a href="#" class="booking-doc-img">
                                <img src="../../../assets2/img/doctors/doctor-thumb-02.jpg" alt="User Image">
                            </a>
                            <div class="profile-det-info">
                                <h3>{{Auth::user()->name}}</h3>

                                <div class="patient-details">
                                    <h5 class="mb-0">Energize Software Toolkit</h5>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-md-7 col-lg-8 col-xl-9">
                                        ...
                                        <div class="dash-widget dct-border-rht">
                                            <div class="circle-bar circle-bar1">
                                                <div class="circle-graph1" data-percent="75">
                                                    <img src="../../../assets2/img/icon-01.png"
                                                         class="img-fluid"
                                                         alt="patient">
                                                </div>
                                            </div>
                                            <div class="dash-widget-info">
                                                <h6>Total Patient</h6>
                                                {{--                                                        <h3>  {{$count =employeeinfos::where([['creator', '=', Auth::user()->name]])->count()}}</h3>--}}
                                        ...
                                        <div class="dash-widget dct-border-rht">
                                            <div class="circle-bar circle-bar2">
                                                <div class="circle-graph2" data-percent="65">
                                                    <img src="../../../assets2/img/icon-02.png"
                                                         class="img-fluid"
                                                         alt="Patient">
                                                </div>
                                            </div>
                                        ...
                                        <div class="dash-widget">
                                            <div class="circle-bar circle-bar3">
                                                <div class="circle-graph3" data-percent="50">
                                                    <img src="../../../assets2/img/icon-03.png"
                                                         class="img-fluid"
                                                         alt="Patient">
                                                </div>
                                            </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <h4 class="mb-4">Employeer WorkSpace</h4>
                                            ...
                                            <div class="table-responsive">
                                                <table class="table table-hover table-center mb-0">
                                                            ...
                                                            <h2 class="table-avatar">
                                                                <a href="patient-profile.html"
                                                                   class="avatar avatar-sm mr-2"><img
                                                                        ...
                                                                        src="../../../assets2/img/patients/patient.jpg"
                                                                        alt="User Image"></a>
                                                        ...
                                                        <td>
                                                            <h2 class="table-avatar">
                                                                <a href="patient-profile.html"
                                                                   class="avatar avatar-sm mr-2"><img
                                                                        class="avatar-img rounded-circle"
                                                                        src="../../../assets2/img/patients/patient1.jpg"
                                                                        alt="User Image"></a>
                                                        ...
                                                        <td>
                                                            <h2 class="table-avatar">
                                                                <a href="patient-profile.html"
                                                                   class="avatar avatar-sm mr-2"><img
                                                                        class="avatar-img rounded-circle"
                                                                        src="../../../assets2/img/patients/patient2.jpg"
                                                                        alt="User Image"></a>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <h2 class="table-avatar">
                                                                <a href="patient-profile.html"
                                                                   class="avatar avatar-sm mr-2"><img
                                                                        class="avatar-img rounded-circle"
                                                                        src="../../../assets2/img/patients/patient3.jpg"
                                                                        alt="User Image"></a>
                                                        ...
                                                        <td>30 Oct 2019 <span
                                                                class="d-block text-info">9.00 AM</span></td>
                                                        <td>General</td>
                                                        <td>Old Patient</td>
                                                        ...
                                                        <td>
                                                            <h2 class="table-avatar">
                                                                <a href="patient-profile.html"
                                                                   class="avatar avatar-sm mr-2"><img
                                                                        class="avatar-img rounded-circle"
                                                                        src="../../../assets2/img/patients/patient4.jpg"
                                                                        alt="User Image"></a>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <h2 class="table-avatar">
                                                                <a href="patient-profile.html"
                                                                   class="avatar avatar-sm mr-2"><img
                                                                        class="avatar-img rounded-circle"
                                                                        src="../../../assets2/img/patients/patient5.jpg"
                                                                        alt="User Image"></a>
                                                        ...
                                                        <td>27 Oct 2019 <span
                                                                class="d-block text-info">8.00 AM</span></td>
                                                        <td>General</td>
                                                        <td>Old Patient</td>
                                                        ...
                                                        <td>
                                                            <h2 class="table-avatar">
                                                                <a href="patient-profile.html"
                                                                   class="avatar avatar-sm mr-2"><img
                                                                        class="avatar-img rounded-circle"
                                                                        src="../../../assets2/img/patients/patient6.jpg"
                                                                        alt="User Image"></a>
