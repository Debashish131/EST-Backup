    ...
    <div class="navbar-container d-flex content">
        ...
        <ul class="nav navbar-nav align-items-center ms-auto">
            ...
            <li class="nav-item dropdown dropdown-notification me-25"><a class="nav-link" href="#"
                        ...
                        class="badge rounded-pill bg-danger badge-up">1</span></a>
                    ...
                    <li class="scrollable-container media-list"><a class="d-flex" href="#">
                            <div class="list-item d-flex align-items-start">
                                ...
                                <div class="list-item-body flex-grow-1">
                                    <p class="media-heading"><span class="fw-bolder">Congratulation {{Auth::user()->name}} Sir 🎉</span>winner!
            ...
            <li class="nav-item dropdown dropdown-user"><a class="nav-link dropdown-toggle dropdown-user-link"
                ...
                <div class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdown-user"><a class="dropdown-item"
                        ...
                        <a class="dropdown-item" href="page-account-settings-account.html"><i class="me-50"
                            ...
                            FAQ</a><a
                            class="dropdown-item" href="/logout"><i class="me-50" data-feather="power"></i>
                            Logout</a>
                </div>
            </li>
        </ul>
    ...
    <div class="navbar-header">
        <ul class="nav navbar-nav flex-row">
            <li class="nav-item me-auto"><a class="navbar-brand"
                       ...
                       <img src="{{ asset('storage/logo.png') }}" alt="tag" height="30" width="200%">
